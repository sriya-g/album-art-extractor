...
Python script that extracts album art from MP3 and FLAC files and saves it as a 100x100 .bmp file in the same directory as the music file. Resulting album art files tested and working on my iPod Photo running Rockbox. Python script only tested on Linux so be careful.
